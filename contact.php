                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                       <div class="contact_message content">
                            <h3>contact us</h3>    
                             <p>This automobile store has many options and many products for the customers to view. One can also request new products and we will facilitate those products to you.</p>
                            <ul>
                                <li><i class="fa fa-fax"></i>  Address : 1155 Union Cir, Denton, TX 76205</li>
                                <li><i class="fa fa-phone"></i> <a href="#">AutoMobile_UNT@gmail.com</a></li>
                                <li><i class="fa fa-envelope-o"></i> +19876543210</li>
                            </ul>             
                        </div> 
                    </div>
                    <div class="col-lg-6 col-md-12">
